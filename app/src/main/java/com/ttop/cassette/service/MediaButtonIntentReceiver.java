...
import static com.ttop.cassette.service.MusicService.CASSETTE_PACKAGE_NAME;
...
public class MediaButtonIntentReceiver extends BroadcastReceiver {
    ...
    private static void acquireWakeLockAndSendMessage(Context context, Message msg, long delay) {
        if (mWakeLock == null) {
            ...
            mWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, CASSETTE_PACKAGE_NAME + ":HeadsetButton");
