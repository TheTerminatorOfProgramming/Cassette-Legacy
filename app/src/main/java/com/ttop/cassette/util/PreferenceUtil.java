...
import com.ttop.cassette.model.CategoryInfo;
import com.ttop.cassette.ui.fragments.mainactivity.folders.FoldersFragment;
import com.ttop.cassette.ui.fragments.player.NowPlayingScreen;
...
public final class PreferenceUtil {
    ...
    public static final String GENERAL_THEME_FOLLOW_SYSTEM_LIGHT_OR_DARK = "system_dark";
    public static final String GENERAL_THEME_FOLLOW_SYSTEM_LIGHT_OR_BLACK = "system_black";
    ...
    public static final String ALBUM_GRID_SIZE_TABLET = "album_grid_size_tablet";
    public static final String ALBUM_GRID_SIZE_TABLET_LAND = "album_grid_size_tablet_land";

    public static final String SONG_GRID_SIZE_TABLET = "song_grid_size_tablet";
    public static final String SONG_GRID_SIZE_TABLET_LAND = "song_grid_size_tablet_land";

    public static final String ARTIST_GRID_SIZE_TABLET = "artist_grid_size_tablet";
    public static final String ARTIST_GRID_SIZE_TABLET_LAND = "artist_grid_size_tablet_land";
    ...
    public static final String EXTRA_PLAYER_CONTROLS = "extra_player_controls";

    public static final String SHOULD_RECREATE = "shouldRecreate";

    public static final String WIDGET_STYLE = "widget_style";

    public static final String WIDGET_THEME = "widget_theme";

    public static final String WIDGET_OVERRIDE = "widget_override";

    public static final String TOGGLE_ADD_CONTROLS = "extra_controls";
    ...
    public static final String PAUSE_ON_ZERO = "pause_on_zero";

    private static final String DESATURATE = "desaturate_colors";
    ...
    public static final String HEADSET_PLAYBACK = "headset_playback";

    public static final String PAUSE_ON_FINISH = "pause_on_finish";

    public static final String EMPTY_QUEUE_ACTION = "empty_queue_action";

    public static final String CIRCLE_PROGRESS = "circle_progress";

    public static final String KEEP_CURRENT_STATE = "keep_current_state";
    ...
    public int getGeneralTheme() {
        return getThemeResFromPrefValue(mPreferences.getString(GENERAL_THEME, GENERAL_THEME_FOLLOW_SYSTEM_LIGHT_OR_DARK));
    }

    @StyleRes
    public static int getThemeResFromPrefValue(String themePrefValue) {
        final boolean isNightMode = (CassetteColorUtil.getSystemNightMode(App.getStaticContext()) == Configuration.UI_MODE_NIGHT_YES);
        ...
        switch (themePrefValue) {
            ...
            case GENERAL_THEME_FOLLOW_SYSTEM_LIGHT_OR_DARK:
                return isNightMode ? R.style.Theme_Cassette : R.style.Theme_Cassette_Light;
            case GENERAL_THEME_FOLLOW_SYSTEM_LIGHT_OR_BLACK:
                return isNightMode ? R.style.Theme_Cassette_Black : R.style.Theme_Cassette_Light;
            case GENERAL_THEME_LIGHT:
            default:
                return R.style.Theme_Cassette_Light;
        }
    }

    public static int getThemeColorFromPrefValue(String themePrefValue) {
        final boolean isNightMode = (CassetteColorUtil.getSystemNightMode(App.getStaticContext()) == Configuration.UI_MODE_NIGHT_YES);

        switch (themePrefValue) {
            case GENERAL_THEME_DARK:
            case GENERAL_THEME_BLACK:
                if (getInstance().getWidgetOverride()){
                    return R.color.md_black_1000;
                }else{
                    return R.color.dark_widget;
                }

            case GENERAL_THEME_FOLLOW_SYSTEM_LIGHT_OR_DARK:
            case GENERAL_THEME_FOLLOW_SYSTEM_LIGHT_OR_BLACK:
                if (getInstance().getWidgetOverride()){
                    return isNightMode ? R.color.md_black_1000 : R.color.md_white_1000;
                }else{
                    return isNightMode ? R.color.dark_widget : R.color.light_widget;
                }
            ...
            default:
                if (getInstance().getWidgetOverride()){
                    ...
                    return R.color.light_widget;
                }
        }
    }

    public static int getWidgetTextColorFromPrefValue(String themePrefValue) {
        final boolean isNightMode = (CassetteColorUtil.getSystemNightMode(App.getStaticContext()) == Configuration.UI_MODE_NIGHT_YES);
        ...
        switch (themePrefValue) {
            ...
            case GENERAL_THEME_FOLLOW_SYSTEM_LIGHT_OR_DARK:
            case GENERAL_THEME_FOLLOW_SYSTEM_LIGHT_OR_BLACK:
                return isNightMode ? R.color.md_white_1000 : R.color.md_black_1000;
            case GENERAL_THEME_LIGHT:
            default:
                return R.color.md_black_1000;
        }
    ...
    public void setWidgetOverride(boolean value) {
        mPreferences.edit()
                .putBoolean(WIDGET_OVERRIDE, value)
                .apply();
    }

    public boolean getWidgetOverride(){
        return mPreferences.getBoolean(WIDGET_OVERRIDE, false);
    }

    public void setWidgetStyle(boolean value){
        mPreferences.edit()
                .putBoolean(WIDGET_STYLE, value)
                .apply();
    }

    public boolean getWidgetStyle(){
        return mPreferences.getBoolean(WIDGET_STYLE, false);
    }

    public void setEmptyQueueAction(boolean value){
        mPreferences.edit()
                .putBoolean(EMPTY_QUEUE_ACTION, value)
                .apply();
    }

    public boolean getEmptyQueueAction(){
        return mPreferences.getBoolean(EMPTY_QUEUE_ACTION, false);
    }
    ...
    public void setPauseZero(boolean value) {
        mPreferences.edit()
                .putBoolean(PAUSE_ON_ZERO, value)
                .apply();
    }

    public boolean getPauseZero(){
        return mPreferences.getBoolean(PAUSE_ON_ZERO, true);
    }

    public void setExpandPanel(boolean value) {
        mPreferences.edit()
                .putBoolean(EXPAND_NOW_PLAYING_PANEL, value)
                .apply();
    }

    public boolean getExpandPanel(){
        return mPreferences.getBoolean(EXPAND_NOW_PLAYING_PANEL, false);
    }

    public void setDesaturate(boolean value){
        mPreferences.edit()
                .putBoolean(DESATURATE, value)
                .apply();
    }

    public boolean getDesaturate(){
        return mPreferences.getBoolean(DESATURATE, false);
    }

    public void setPauseOnFinish(boolean value) {
        mPreferences.edit()
                .putBoolean(PAUSE_ON_FINISH, value)
                .apply();
    }

    public boolean getPauseOnFinish(){
        return mPreferences.getBoolean(PAUSE_ON_FINISH, false);
    }

    public void setExtraControls(boolean value) {
        mPreferences.edit()
                .putBoolean(TOGGLE_ADD_CONTROLS, value)
                .apply();
    }

    public boolean getExtraControls(){
    ...
    public void setAlbumGridSizeTablet(int gridSize) {
        mPreferences.edit()
                .putInt(ALBUM_GRID_SIZE_TABLET, gridSize)
                .apply();
    }

    public int getAlbumGridSizeTablet(Context context) {
        return mPreferences.getInt(ALBUM_GRID_SIZE_TABLET, context.getResources().getInteger(R.integer.default_grid_columns));
    }

    public void setAlbumGridSizeTabletLand(int gridSize) {
        mPreferences.edit()
                .putInt(ALBUM_GRID_SIZE_TABLET_LAND, gridSize)
                .apply();
    }

    public int getAlbumGridSizeTabletLand(Context context) {
        return mPreferences.getInt(ALBUM_GRID_SIZE_TABLET_LAND, context.getResources().getInteger(R.integer.default_grid_columns_land));
    }
    ...
    public void setSongGridSizeTablet(int gridSize) {
        mPreferences.edit()
                .putInt(SONG_GRID_SIZE_TABLET, gridSize)
                .apply();
    }

    public int getSongGridSizeTablet(Context context) {
        return mPreferences.getInt(SONG_GRID_SIZE_TABLET, context.getResources().getInteger(R.integer.default_list_columns));
    }

    public void setSongGridSizeTabletLand(int gridSize) {
        mPreferences.edit()
                .putInt(SONG_GRID_SIZE_TABLET_LAND, gridSize)
                .apply();
    }

    public int getSongGridSizeTabletLand(Context context) {
        return mPreferences.getInt(SONG_GRID_SIZE_TABLET_LAND, context.getResources().getInteger(R.integer.default_list_columns_land));
    }
    ...
    public void setArtistGridSizeTablet(int gridSize) {
        mPreferences.edit()
                .putInt(ARTIST_GRID_SIZE_TABLET, gridSize)
                .apply();
    }

    public int getArtistGridSizeTablet(Context context) {
        return mPreferences.getInt(ARTIST_GRID_SIZE_TABLET, context.getResources().getInteger(R.integer.default_list_columns));
    }

    public void setArtistGridSizeTabletLand(final int gridSize) {
        mPreferences.edit()
                .putInt(ARTIST_GRID_SIZE_TABLET_LAND, gridSize)
                .apply();
    }

    public int getArtistGridSizeTabletLand(Context context) {
        return mPreferences.getInt(ARTIST_GRID_SIZE_TABLET_LAND, context.getResources().getInteger(R.integer.default_list_columns_land));
    }
    ...
    public boolean checkPreferences (String setting){
        return mPreferences.contains(setting);
    }

    public void setShouldRecreate(boolean value) {
        mPreferences.edit()
    ...
    public boolean getShouldRecreate(){
        return mPreferences.getBoolean(SHOULD_RECREATE, false);
    }

    public void setAppTheme(String theme){
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putString(WIDGET_THEME, theme);
        editor.apply();
    }

    public String getAppTheme(){
        return mPreferences.getString(WIDGET_THEME, GENERAL_THEME_FOLLOW_SYSTEM_LIGHT_OR_DARK);
    }

    public void setOriginalAccentColor(int value){
        mPreferences.edit()
                .putInt(ACCENT_COLOR, value)
                .apply();
    }

    public int getOriginalAccentColor(){
        return mPreferences.getInt(ACCENT_COLOR, R.color.md_red_700);
    }

    public void setOriginalPrimaryColor(int value){
        mPreferences.edit()
                .putInt(PRIMARY_COLOR, value)
                .apply();
    }

    public int getOriginalPrimaryColor(){
        return mPreferences.getInt(PRIMARY_COLOR, R.color.md_blue_700);
    }

    public void setExtraPlayerControls(boolean value) {
        mPreferences.edit()
                .putBoolean(EXTRA_PLAYER_CONTROLS, value)
                .apply();
    }

    public boolean getExtraPlayerControls(){
        return mPreferences.getBoolean(EXTRA_PLAYER_CONTROLS, false);
    }

    public void setCircleProgress(boolean value){
        mPreferences.edit()
                .putBoolean(CIRCLE_PROGRESS, value)
                .apply();
    }

    public boolean getCircleProgress(){
        return mPreferences.getBoolean(CIRCLE_PROGRESS, false);
    }

    public void setScreenOn(boolean value){
        mPreferences.edit()
                .putBoolean(SCREEN_ON, value)
                .apply();
    }

    public boolean getScreenOn(){
        return mPreferences.getBoolean(SCREEN_ON, false);
    }

    public void setImmersiveMode(boolean value){
        mPreferences.edit()
                .putBoolean(IMMERSIVE_MODE, value)
                .apply();
    }

    public boolean getImmersiveMode(){
        return mPreferences.getBoolean(IMMERSIVE_MODE, false);
    }

    public void setHeadsetPlayback(boolean value){
        mPreferences.edit()
                .putBoolean(HEADSET_PLAYBACK, value)
                .apply();
    }

    public boolean getHeadsetPlayback(){
        return mPreferences.getBoolean(HEADSET_PLAYBACK, false);
    }

    public void setCurrentState(boolean value){
        mPreferences.edit()
                .putBoolean(KEEP_CURRENT_STATE, value)
                .apply();
    }

    public boolean getCurrentState(){
        return mPreferences.getBoolean(KEEP_CURRENT_STATE, false);
    }
}
