...
public class ViewUtil {
    ...
    public final static int CASSETTE_ANIM_TIME = 1000;
    public final static ImageView.ScaleType CASSETTE_ALBUM_ART_SCALE_TYPE = ImageView.ScaleType.CENTER_CROP;
    ...
    private static Animator createColorAnimator(Object target, String propertyName, @ColorInt int startColor, @ColorInt int endColor) {
        ...
        animator.setDuration(CASSETTE_ANIM_TIME);
        return animator;
    }
