package com.ttop.cassette.appshortcuts.shortcuttype;
...
import com.ttop.cassette.appshortcuts.AppShortcutLauncherActivity;
...
public abstract class BaseShortcutType {
    ...
    static final String ID_PREFIX = "com.ttop.cassette.appshortcuts.id.";
