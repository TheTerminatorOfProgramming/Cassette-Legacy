...
import com.ttop.cassette.databinding.FragmentAlbumCoverBinding;
...
import com.ttop.cassette.misc.CustomFragmentStatePagerAdapter;
...
public class AlbumCoverPagerAdapter extends CustomFragmentStatePagerAdapter {
    ...
    public static class AlbumCoverFragment extends Fragment {
        ...
        public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
            ...
            albumCover.setScaleType(CASSETTE_ALBUM_ART_SCALE_TYPE);
            loadAlbumCover();
        }
        ...
        private void loadAlbumCover() {
            GlideApp.with(this)
                    ...
                    .songOptions(song)
                    .into(new CassetteColoredTarget(albumCover) {
                        @Override
