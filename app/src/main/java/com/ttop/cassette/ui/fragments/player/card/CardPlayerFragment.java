...
import com.ttop.cassette.databinding.FragmentCardPlayerBinding;
import com.ttop.cassette.databinding.ItemListBinding;
import com.ttop.cassette.dialogs.LyricsDialog;
...
import com.ttop.cassette.model.lyrics.Lyrics;
import com.ttop.cassette.ui.activities.base.AbsSlidingMusicPanelActivity;
import com.ttop.cassette.ui.fragments.player.AbsPlayerFragment;
import com.ttop.cassette.ui.fragments.player.PlayerAlbumCoverFragment;
...
import com.ttop.cassette.views.WidthFitSquareLayout;
...
public class CardPlayerFragment extends AbsPlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    ...
    private static abstract class BaseImpl implements Impl {
        ...
        public AnimatorSet createDefaultColorChangeAnimatorSet(int newColor) {
            ...
            animatorSet.setDuration(ViewUtil.CASSETTE_ANIM_TIME);
            return animatorSet;
        }
