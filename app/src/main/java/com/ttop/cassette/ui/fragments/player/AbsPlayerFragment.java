...
import com.ttop.cassette.adapter.song.PlayingQueueAdapter;
...
import com.ttop.cassette.dialogs.SongDetailDialog;
import com.ttop.cassette.dialogs.SongShareDialog;
...
import com.ttop.cassette.ui.activities.tageditor.SongTagEditorActivity;
...
public abstract class AbsPlayerFragment extends AbsMusicServiceFragment implements Toolbar.OnMenuItemClickListener, PaletteColorHolder {
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        if (itemId == R.id.action_sleep_timer) {
            ...
            return true;
        }else if (itemId == R.id.action_pause_finished) {
            item.setChecked(!item.isChecked());
            PreferenceUtil.getInstance().setPauseOnFinish(item.isChecked());
            return true;
        }
        return false;
    }
