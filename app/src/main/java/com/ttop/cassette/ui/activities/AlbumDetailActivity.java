...
import com.ttop.cassette.adapter.song.AlbumSongAdapter;
import com.ttop.cassette.databinding.ActivityAlbumDetailBinding;
...
import com.ttop.cassette.dialogs.SleepTimerDialog;
...
import com.ttop.cassette.helper.menu.MenuHelper;
import com.ttop.cassette.interfaces.CabHolder;
import com.ttop.cassette.interfaces.LoaderIds;
import com.ttop.cassette.interfaces.PaletteColorHolder;
import com.ttop.cassette.lastfm.rest.LastFMRestClient;
import com.ttop.cassette.lastfm.rest.model.LastFmAlbum;
import com.ttop.cassette.loader.AlbumLoader;
import com.ttop.cassette.misc.SimpleObservableScrollViewCallbacks;
...
import com.ttop.cassette.ui.activities.tageditor.AbsTagEditorActivity;
import com.ttop.cassette.ui.activities.tageditor.AlbumTagEditorActivity;
...
public class AlbumDetailActivity extends AbsSlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Album> {
    ...
    private void loadAlbumCover() {
        GlideApp.with(this)
                .asBitmapPalette()
                .load(CassetteGlideExtension.getSongModel(getAlbum().safeGetFirstSong()))
                .transition(CassetteGlideExtension.getDefaultTransition())
                .songOptions(getAlbum().safeGetFirstSong())
                .dontAnimate()
                .into(new CassetteColoredTarget(albumArtImageView) {
                    @Override
    ...
    public MaterialCab openCab(int menuRes, @NonNull final MaterialCab.Callback callback) {
        ...
        cab = new MaterialCab(this, R.id.cab_stub)
                ...
                .setBackgroundColor(CassetteColorUtil.shiftBackgroundColorForLightText(getPaletteColor()))
